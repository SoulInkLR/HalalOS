...
$$($(1)_TARGET): $$(APPS_STD_TARGET) $$($(1)_OBJS) build/apps.mk
	$$(LD) $$(APP_LDFLAGS) --oformat=binary -o $$@ $$(filter-out build/apps.mk, $$(filter-out $$<, $$^)) $(OUTPUT)/libstd.a
	$$(LD) $$(APP_LDFLAGS) -o $$(@).elf $$(filter-out build/apps.mk, $$(filter-out $$<, $$^)) $(OUTPUT)/libstd.a
